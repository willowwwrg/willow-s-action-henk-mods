...
public class CameraPath : MonoBehaviour
{
	...
	public static float CURRENT_VERSION_NUMBER = 3.32f;
	...
	public float DeNormalisePercentage(float normalisedPercent)
	{
		...
		for (int i = 0; i < num; i++)
		{
			if (_normalisedPercentages[i] > normalisedPercent)
			{
				...
				float num3 = _normalisedPercentages[i - 1];
				float num4 = _normalisedPercentages[i];
				float t = (normalisedPercent - num3) / (num4 - num3);
				return Mathf.Lerp(num2, to, t);
			}
		}
		return 1f;
	}
