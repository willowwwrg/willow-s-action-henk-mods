...
public class PerformanceObscuredTests : MonoBehaviour
{
	...
	private void TestString()
	{
		...
		_ = text2 != string.Empty;
		_ = obscuredString != (ObscuredString)string.Empty;
		_ = text != string.Empty;
	}
	...
	private void TestVector3()
	{
		...
		_ = obscuredVector != Vector3.zero;
		_ = vector != Vector3.zero;
	}
