...
public struct HSBColor
{
	...
	{
		Debug.Log("red: " + new HSBColor(Color.red).ToString());
		Debug.Log("green: " + new HSBColor(Color.green).ToString());
		Debug.Log("blue: " + new HSBColor(Color.blue).ToString());
		Debug.Log("grey: " + new HSBColor(Color.grey).ToString());
		Debug.Log("white: " + new HSBColor(Color.white).ToString());
		Debug.Log("0.4, 1f, 0.84: " + new HSBColor(new Color(0.4f, 1f, 0.84f, 1f)).ToString());
