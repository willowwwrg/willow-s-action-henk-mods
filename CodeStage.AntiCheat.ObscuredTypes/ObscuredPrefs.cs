...
public static class ObscuredPrefs
{
	...
	public static int GetInt(string key, int defaultValue)
	{
		...
		int.TryParse(GetData(key2, defaultValue.ToString()), out var result);
		return result;
	}
	...
	public static float GetFloat(string key, float defaultValue)
	{
		...
		float.TryParse(GetData(key2, defaultValue.ToString()), out var result);
		return result;
	}
	...
	{
		double.TryParse(GetData(EncryptKey(key), defaultValue.ToString()), out var result);
		return result;
	}
	...
	{
		long.TryParse(GetData(EncryptKey(key), defaultValue.ToString()), out var result);
		return result;
	}
	...
	{
		int.TryParse(GetData(EncryptKey(key), (defaultValue ? 1 : 0).ToString()), out var result);
		return result == 1;
	}
	...
	private static string DecryptValue(string value)
	{
		...
		string result = ObscuredString.EncryptDecrypt(Encoding.UTF8.GetString(array2, 0, array2.Length), encryptionKey);
		if (array.Length == 3)
		{
