...
public class SupportLogging : MonoBehaviour
{
	...
	private void LogBasics()
	{
		...
		stringBuilder.AppendFormat("SupportLogger Info: PUN {0}: ", "1.26");
		stringBuilder.AppendFormat("AppID: {0}*** GameVersion: {1} ", PhotonNetwork.networkingPeer.mAppId.Substring(0, 8), PhotonNetwork.networkingPeer.mAppVersion);
